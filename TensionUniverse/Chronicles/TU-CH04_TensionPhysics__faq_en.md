...
<img width="1536" height="1024" alt="TensionPhysics (1)" src="https://github.com/user-attachments/assets/92cc4e1f-8a69-4191-a1a9-8bb44aeea347" />
...
1. Take a specific BlackHole problem that TU-CH05 references.  
2. Ask the AI to restate it in standard physics language and in tension language, side by side.  
3. Ask the AI to list where the two framings obviously agree and where they might disagree.  
4. Then ask for at least one way the tension framing could be misleading or incomplete for that problem.  
